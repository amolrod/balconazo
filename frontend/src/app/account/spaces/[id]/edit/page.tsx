...
export default function EditSpacePage() {
  ...
  useEffect(() => {
    ...
    fetchSpace()
  }, [authLoading, isAuthenticated, spaceId, login])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await spacesApi.update(token, spaceId, formData)
      router.push('/account/spaces')
    } catch (err: unknown) {
      const error = err as { data?: { message?: string } }
      setError(error.data?.message || 'Error al actualizar el espacio')
    } finally {
    ...
    <div className="min-h-screen bg-secondary-50 py-8">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-secondary-900">Editar espacio</h1>
